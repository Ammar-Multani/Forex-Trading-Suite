...
import { TextInput, Text, Divider, IconButton, Button, Chip } from 'react-native-paper';
      ...
      <CalculatorCard title="Pip Difference Calculator">
        <View style={styles.inputsContainer}>
          <View style={styles.pairSelectorContainer}>
            ...
            >
              <Text style={{ color: isDark ? '#fff' : '#000' }}>{currencyPair}</Text>
              <Ionicons 
              ...
              <View style={[
                ...
                <ScrollView>
                  {COMMON_PAIRS.map(pair => (
                    ...
                    >
                      <Text style={{ color: isDark ? '#fff' : '#000' }}>{pair}</Text>
                    </TouchableOpacity>
                  ))}
                </ScrollView>
              </View>
        ...
        <View style={styles.resultsContainer}>
          <View style={styles.resultHeader}>
            <Text variant="titleMedium" style={{ color: isDark ? '#fff' : '#000' }}>Result</Text>
            <IconButton
              icon="refresh"
              size={20}
          ...
          <View style={styles.mainResult}>
            ...
            />
            <Text variant="displaySmall" style={{ color: getDirectionColor(direction), fontWeight: 'bold' }}>
              {pipDifference.toFixed(1)}
            </Text>
            <Text variant="titleMedium" style={{ color: isDark ? '#aaa' : '#666' }}>pips</Text>
          </View>
          
          <Text variant="bodySmall" style={{ color: isDark ? '#aaa' : '#666', textAlign: 'center', marginTop: 8 }}>
            {direction === 'up' ? 'Price increased' : direction === 'down' ? 'Price decreased' : 'No change'}
          </Text>
        </View>
                ...
                {history.map((item, index) => (
                  <View key={index} style={styles.historyItem}>
                    <View style={styles.historyItemLeft}>
                      <Text variant="bodyMedium" style={{ color: isDark ? '#fff' : '#000' }}>{item.pair}</Text>
                    ...
                    <View style={styles.historyItemRight}>
                      ...
                      <Text 
                        variant="bodyMedium" 
                        style={{ color: getDirectionColor(item.direction), fontWeight: 'bold' }}
                      >
