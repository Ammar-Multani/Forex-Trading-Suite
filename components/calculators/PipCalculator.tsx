...
import { TextInput, Text, Divider, IconButton, Chip, Button, ActivityIndicator } from 'react-native-paper';
        ...
        >
          <View style={styles.rateContainer}>
            <View style={styles.rateHeader}>
              <Text variant="bodyMedium" style={{ color: isDark ? '#aaa' : '#666' }}>
                Current Rate:
              </Text>
              {isLoading && !refreshing ? (
                <ActivityIndicator size={16} color="#6200ee" style={{ marginLeft: 8 }} />
              ) : (
                <IconButton
                  icon="refresh"
                  size={16}
            ...
            <View style={styles.rateValue}>
              <Text variant="titleMedium" style={{ color: isDark ? '#fff' : '#000', fontWeight: 'bold' }}>
          ...
          <View style={styles.inputsContainer}>
            ...
            <Text variant="bodySmall" style={{ marginBottom: 8 }}>Position Size</Text>
              ...
              {LOT_SIZES.map(lot => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    {
                      backgroundColor: selectedLotSize === lot.value || (customLotSize && lot.value === 'custom')
                        ? '#6200ee'
                ...
                >
                  <Text
                    style={{
                      color: selectedLotSize === lot.value || (customLotSize && lot.value === 'custom')
                        ? '#fff'
                        : isDark ? '#fff' : '#000',
                      fontSize: 12,
                    }}
          ...
          <View style={styles.resultsContainer}>
            ...
            <View style={styles.resultCards}>
              <View style={[
                ...
                <Text variant="bodyMedium" style={{ color: isDark ? '#aaa' : '#666' }}>Pip Value</Text>
